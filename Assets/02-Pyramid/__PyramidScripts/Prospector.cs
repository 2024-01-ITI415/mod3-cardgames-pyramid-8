...
public class Prospector : MonoBehaviour {
	...
	public Text					gameOverText, roundResultText, roundResultLostText, highScoreText;
	...
	void SetUpUITexts() {
		...
		go = GameObject.Find("RoundResultLost");
		if(go != null) {
			roundResultLostText = go.GetComponent<Text>();
		}
	...
	void ShowResultsUI(bool show) {
		...
		roundResultLostText.gameObject.SetActive(show);
	}
	...
	CardProspector Draw() {
		CardProspector cd = drawPile[0]; // Pull the 0th Card Prospector
		drawPile.RemoveAt(0); 			 // Then remove it from List<> drawPile
		return(cd);						 // And return it
	}

	// Layout() positions the initial tableau of cards, a.k.a. the "mine"
	void LayoutGame() {
		...
		foreach(SlotDef tSD in layout.slotDefs) {
			...
			cp.transform.localPosition = new UnityEngine.Vector3 (
	...
	void GameOver(bool won) {
		...
		if(won) {
			...
			roundResultText.text = "You won this!\nRound Score: " + score;
			ShowResultsUI(true);
			...
			roundResultLostText.text = "Awwwwww, Nice Try!";
			/*
